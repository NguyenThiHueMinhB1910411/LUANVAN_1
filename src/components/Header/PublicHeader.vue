...
<header>
    <div class="container">
        <div class="row">
            <div class="col-3">
                <img src="https://www.purina.com/sites/default/files/new-logo1.png" alt="Logo" class="mt-5 w-50 d-block" />
            </div>
            <div class="col-7 d-flex flex-column">
                ...
                <nav class="mt-4">
                    ...
                    <router-link :to="{name:'Booking'}">Đặt lịch</router-link>
                </nav>
            </div>
            <div class="col-2">
                <div class="d-flex flex-row justify-content-between">
                    <router-link :to="{name: 'Login'}">
                        <p class="me-2 px-1 text-center border rounded-2 bg-white text-danger fw-bold w- border-white py-1" style="margin-top: 30px">
                            Đăng nhập
                        </p>
                    </router-link>
                    <router-link :to="{name: 'Register'}">
                        <p class="px-2 text-center border rounded-2 bg-white text-danger fw-bold w- border-white py-1" style="margin-top: 30px">
                            Đăng ký
                        </p>
                    </router-link>
                </div>
